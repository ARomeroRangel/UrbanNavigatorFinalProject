<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login - admin.aspx.cs" Inherits="UrbanNavigator.WebForm1" %>
<%@ Register TagPrefix="cse" TagName="registration" Src="~/usercontrols/registration.ascx"%>
<%@ Register TagPrefix="cse" TagName="loginform" Src="~/usercontrols/loginform - admin.ascx" %>
<!DOCTYPE html>
...
<body>
	...
	<title>Login - CSE445/598 Final Project - Armando Romero & Jerome Ronquillo</title>
